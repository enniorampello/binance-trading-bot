...
def import_data_1m():
    ...
    return kline_to_csv(kline,'training-data-1min')
...
def import_data_5m():
    ...
    return kline_to_csv(kline,'training-data-5min')
...
def import_data_15m():
    ...
    return kline_to_csv(kline,'training-data-15min')
...
def import_data_30m():
    ...
    kline = client.get_historical_klines(symbol='BTCUSDT',
                                         ...
                                         start_str='1 year ago')
    return kline_to_csv(kline,'training-data-30min')
...
def import_data_1h():
    ...
    kline = client.get_historical_klines(symbol='BTCUSDT',
                                         ...
                                         start_str='1 year ago')
    return kline_to_csv(kline, 'training-data-1h')
...
def import_data_2h():
    ...
    kline = client.get_historical_klines(symbol='BTCUSDT',
                                         ...
                                         start_str='1 year ago')
    return kline_to_csv(kline, 'training-data-2h')
...
def import_data_4h():
    ...
    kline = client.get_historical_klines(symbol='BTCUSDT',
                                         ...
                                         start_str='1 year ago')
    return kline_to_csv(kline, 'training-data-4h')
...
def import_data_6h():
    ...
    kline = client.get_historical_klines(symbol='BTCUSDT',
                                         ...
                                         start_str='1 year ago')
    return kline_to_csv(kline, 'training-data-6h')
...
def import_data_12h():
    ...
    kline = client.get_historical_klines(symbol='BTCUSDT',
                                         ...
                                         start_str='1 year ago')
    return kline_to_csv(kline, 'training-data-12h')
...
def import_data_1d():
    ...
    kline = client.get_historical_klines(symbol='BTCUSDT',
                                         ...
                                         start_str='1 year ago')
    return kline_to_csv(kline, 'training-data-1d')